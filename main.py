            ...
            if world_state.is_mission_running:
                ...
                if obs_num > 0:
                    ...
                    if u"LineOfSight" in ob:
                        ...
                        if i == 1:
                            builder_mode = update_builder_mode(agent_hosts[0], los, names[0], builder_mode, size, entities[1])
                        if i == 2 and allow_architect_builder:
                            architect_mode  = update_builder_mode(agent_hosts[0], los, names[1], architect_mode, size, entities[0])      
